...
/**
 * This is the model class for table "bla_lang".
 *
 * @property integer $id
 * @property string $url
...
class Lang extends \yii\db\ActiveRecord
{
    ...
    // Отримання обєкту мови позамовчуванню
    static function getDefaultLang()
    {
        return Lang::find()->where('`default` = :default', [':default' => 1])->one();
    }

    // Отримання мови по буквенному ідентифікатору
